 ...
 * Date: 10 Dec 2002
 * CVS: $Id: pf_pdf.c,v 1.4 2003/05/21 17:39:15 inspectorg Exp $
 *************************************************************************/
...
pf_pdf_discrete_t *pf_pdf_discrete_alloc(int count, double *probs)
{
  ...
  pdf = (pf_pdf_discrete_t*) calloc(1, sizeof(pf_pdf_discrete_t));

  pdf->prob_count = count;
  pdf->probs = (double*) malloc(count * sizeof(double));
